...
export const gridItems = [
  ...
  },
  {
    ...
    description: "",
    className: "lg:col-span-4 md:col-span-3 md:row-span-7 row-span-2 sm:grid-rows-2 lg:row-span-4",
    imgClassName: "",
  ...
  },
  {
    ...
    description: "",
    className: "lg:col-span-4 md:col-span-3 md:row-span-2 sm:grid-rows-1 lg:row-span-2",
    imgClassName: "",
    titleClassName: "justify-start",
    img: "/grid.svg",
    spareImg: "/b4.svg",
