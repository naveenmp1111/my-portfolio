...
const Hero = () => {
    return (
        ...
        <div className='pb-1 md:pb-16 md:pt-36 lg:36 pt-28'>
            ...
            <div className="md:h-[700px] h-[550px] sm:h-[600px] w-full dark:bg-black-100 bg-white  dark:bg-grid-white/[0.05] bg-grid-black/[0.3] flex items-center justify-center absolute top-0 left-0">
            ...
            <div className='flex justify-center relative my-20 z-10'>
                ...
                className='max-w-[89vw] flex flex-col md:gap-0 gap-2'>
                    <h2 className='uppercase tracking-widest sm:text-sm text-xs text-center text-blue-100'>Hey! I'm excited to share my journey with you.</h2>
                    <TextGenerateEffect
